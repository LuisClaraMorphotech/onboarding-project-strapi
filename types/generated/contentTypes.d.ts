...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    recommendedAge: Attribute.Integer;
    stockLimit: Attribute.Integer;
    pieceCount: Attribute.BigInteger;
    insidersPoints: Attribute.BigInteger;
    miniFigures: Attribute.Integer;
